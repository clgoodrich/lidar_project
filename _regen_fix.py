...
# ============================================================
# GRAPHIC 1: Manual Picks (slide 9)
# ============================================================
zone_size = 800
best = (0, 0, 0)
...
# Manual picks - white fill, black border stars
if len(z_ann) > 0:
    ax.scatter(z_ann.geometry.x, z_ann.geometry.y,
               c='white', s=350, marker='*',
               edgecolors='black', linewidths=0.8, zorder=2)

# All wells - single bright color, big
if len(z_wells) > 0:
...
elems = [
    ...
    Line2D([0], [0], marker='*', color='w', markerfacecolor='white',
           markeredgecolor='black', markersize=16, markeredgewidth=0.8,
           label=f'Manual Picks ({len(z_ann)})', linestyle='None'),
]
...
# ============================================================
# GRAPHIC 2: DEP Records Problem (slide 6)
# ============================================================
...
# Annotations - white stars with black border
if len(z_ann2) > 0:
...
elems = [
    ...
    Line2D([0], [0], marker='*', color='w', markerfacecolor='white',
           markeredgecolor='black', markersize=16, markeredgewidth=0.8,
           label=f'Visible Pits ({len(z_ann2)})', linestyle='None'),
]
leg = ax.legend(handles=elems, loc='upper right', fontsize=13,
          facecolor='#1a1a2e', edgecolor='#444466', labelcolor='white', framealpha=0.9)
