# FINESST Project Summary — draft for NSPIRES cover page (Section VII)
...
Previous work has identified where Antarctic Dry Valley streams are reshaping the
land, but it stops at location. It does not say why. This project attributes two
decades of measured stream-channel change in the McMurdo Dry Valleys to its climate
drivers. Three elevation epochs cover the valleys: a 2001 NASA airborne lidar DEM, a
2014 airborne lidar DEM, and 2021–23 REMA satellite DEMs co-registered to the
airborne lidar and ICESat-2 control. Differencing them shows where the land moved.
...
*~250 words. NSPIRES allows up to 4000 characters — this fits with room to spare.*
