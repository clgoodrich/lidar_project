...
Run:
    python docs/presentation/figures_30to45min/report_lidar_ground/_build_report_figures.py
"""
...
def chart_cliff(cur):
    ...
    save(fig, "chart_1_the_cliff.png")
...
def chart_two_surveys(stops):
    ...
    save(fig, "chart_2_two_surveys.png")
...
def chart_accuracy(acc):
    ...
    save(fig, "chart_3_how_accurate.png")
...
def chart_what_they_are(xt):
    ...
    ax.spines["left"].set_visible(False)
    save(fig, "chart_4_what_they_are.png")
...
def chart_holes(rows):
    ...
    ax.spines["left"].set_visible(False)
    save(fig, "chart_5_holes_closed.png")
...
def chart_where_changed(rows):
    ...
    ax.spines["left"].set_visible(False)
    save(fig, "chart_6_where_changed.png")
...
def chart_trees(vs):
    ...
    save(fig, "chart_7_trees_shorter.png")
...
def map_holes():
    ...
    ax.text(x0 + bar / 2, y0 + 60, "300 m", ha="center", fontsize=12.5,
            color=INK)
    save(fig, "map_1_holes_in_stripes.png")
