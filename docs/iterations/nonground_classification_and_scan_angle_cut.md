...
docs/presentation/figures_30to45min/1_data_qa/
    ...
    scan_angle_accuracy_9t.png
    ground_classification_cliff_by_acquisition.png

docs/presentation/figures_30to45min/1_data_qa/
    cross_section_pit_72m_616591.png
    cross_section_pad_357m_621594.png
    cross_section_line_200m_622593.png
```
...
docs/presentation/figures_30to45min/1_data_qa/
    scan_angle_cliff_by_survey_all_tiles.png

docs/presentation/figures_30to45min/1_data_qa/
    report_1_the_cliff_9t.png        now all 177 squares, not one
    report_2_two_surveys_9t.png      one row per flight block
```
