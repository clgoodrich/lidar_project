...
v5, 2026-07-27. 1,964 characters / 310 words (AGU limit 2,000).
...
| detectors do not displace the U-Nets | P 0.54-0.69, F1 0.653-0.748 | `_reeval_9t.json` |
...
## Voice check
Median sentence 10 words, max 20, 27 sentences, 1,964 characters. No em-dashes,
...
If you need ~90 more characters, "Mask R-CNN and YOLO do not displace the
U-Nets." is the least load-bearing sentence.
