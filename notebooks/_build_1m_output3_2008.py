"""Build the full 1 m raster stack from output3_2008.las (PAMAP 2006-2008).

At 0.5 m the 2008 tile has only ~0.09 ground pts/cell — too sparse for the
fine-scale derivatives. 1 m gives ~0.35 pts/cell, much more reasonable.

All outputs labeled with `_2008_1m.tif` so they sit alongside 2019 _05.tif
and 2008 _2008_05.tif without collision.

Outputs (all 1 m grid, 1500x1500 cells, EPSG:6346):
  dem_2008_1m.tif, dsm_2008_1m.tif, chm_2008_1m.tif
  ground_density_2008_1m.tif, intensity_ground_2008_1m.tif
  hillshade_2008_1m.tif, slope_2008_1m.tif
  roughness_5_2008_1m.tif (11-cell window rescaled to 5-cell at 1 m)
  local_relief_10_2008_1m.tif
  lrm_{3,5,11,25}_2008_1m.tif   (cell sizes scaled from 0.5 m run: 5,11,25,51)
  tpi_{05,15,25}_2008_1m.tif, tpi_grad_{mag,dir}_2008_1m.tif
  openness_{pos,neg}_2008_1m.tif
"""
...
print(f'DEM 2008 (1m): nan {100*np.isnan(dem).mean():.2f}%   z {np.nanmin(dem):.1f}..{np.nanmax(dem):.1f}')
...
# Roughness (5-cell window at 1 m ~ 5 m diameter, matches 11-cell at 0.5 m)
WIN = 5
...
# LRM — 0.5 m sizes were 5/11/25/51 cells. At 1 m use 3/5/11/25 (halved).
...
# Openness L=25 m -> 25 cells at 1 m
...
print('computing openness at 1 m, L=25 m (25 cells)...')
