...
add_fig(str(ROOT / 'docs/figures/Pennsylvania Map.png'),
        'Distribution of documented oil and gas wells across Pennsylvania.')

add_fig(str(ROOT / 'docs/figures/Pennsylvania Map Abandoned.png'),
        'Distribution of abandoned wells in Pennsylvania.')

placeholder()

add_fig(str(ROOT / 'docs/figures/region_with_trees.png'),
        'Satellite imagery of the study area. Dense canopy hides all terrain features.')

placeholder()

add_fig(str(ROOT / 'docs/figures/region_without_trees.png'),
...
add_fig(str(ROOT / 'docs/figures/Areas of Interest.png'),
...
add_fig(str(ROOT / 'docs/figures/Pennsylvania AOI.png'),
