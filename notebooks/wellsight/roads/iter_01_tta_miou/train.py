"""Road U-Net iter 01 — TTA + miou checkpoint.

Mirror of pit iter 01 applied to binary road segmentation:
  1) Save by val road IoU (the existing _road_unet.py already does this).
  2) 8-fold TTA at inference (4 rotations x 2 flips).

Output dir: data/derivatives/9t/iterations/road_01_tta_miou/
"""
...
OUTDIR = D / "iterations" / "road_01_tta_miou"; OUTDIR.mkdir(parents=True, exist_ok=True)
    ...
    for ep in range(1, args.epochs + 1):
        ...
        if iou_road > best_iou:
            ...
            torch.save({"state_dict": model.state_dict(), "mu": mu, "sd": sd,
                        ...
                        "iou_road": iou_road}, OUTDIR / "best.pt")
