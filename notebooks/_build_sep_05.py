"""Build 0.5 m derivative stack from the 16-tile mosaic in
'data/files/seperate sections/'.  Uses existing sep_merged.las.

Grid: 12000 x 12000 cells, 0.5 m, extent 562500-568500 E, 4464000-4470000 N.
Outputs tagged _sep_05.
"""
...
# (1) DEM
print('=== DEM (TIN over ground) ===', flush=True)
...
# (3) Density + intensity
print('=== density + intensity ===', flush=True)
...
# (4) Hillshade + slope
print('=== hillshade + slope ===', flush=True)
import whitebox
...
print(f'wrote hillshade_{SFX} + slope_{SFX}', flush=True)
...
# Roughness 11-cell (~5.5 m at 0.5 m)
print('=== roughness + local_relief ===', flush=True)
WIN = 11
...
# Openness
print('=== openness (slowest step) ===', flush=True)
...
panels = [
    ...
    (f'lrm_25_{SFX}.tif',           'LRM 25',              'RdBu_r', (-0.8, 0.8)),
...
fig.suptitle(f'separate sections — 6 km x 6 km — 0.5 m derivative stack', fontsize=14)
