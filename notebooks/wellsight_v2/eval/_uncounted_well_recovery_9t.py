...
Run:
  python notebooks/wellsight_v2/eval/_uncounted_well_recovery_9t.py
"""
...
ANN_DIR = ROOT / "data" / "derivatives" / "annotations"
ANN_GPKG = ANN_DIR / "annotations_proj.gpkg"
OUT = ROOT / "data" / "derivatives" / "eval_9t_uncounted_wells"
