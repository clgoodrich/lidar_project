...
Set up auth ONCE, then run this:
  ...
  3) python notebooks/wellsight_v2/build/_fetch_nisar_9t.py            # GCOV + GUNW
     python notebooks/wellsight_v2/build/_fetch_nisar_9t.py --list     # plan only
     python notebooks/wellsight_v2/build/_fetch_nisar_9t.py --collections NISAR_L2_GCOV_BETA_V1
