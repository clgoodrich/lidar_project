...
CLI:
  python notebooks/wellsight_v2/build/_build_label_grids.py --region westernpa --dry-run
  python notebooks/wellsight_v2/build/_build_label_grids.py --region westernpa
  python notebooks/wellsight_v2/build/_build_label_grids.py --region permian  --dry-run
"""
