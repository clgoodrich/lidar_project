...
img(s, ROOT / 'Pennsylvania Map.png', 6.5, 1.2, width=6.3)
...
img(s, ROOT / 'region_with_trees.png', 6.0, 1.2, width=3.3)
img(s, ROOT / 'region_without_trees.png', 9.5, 1.2, width=3.3)
...
img(s, ROOT / 'Manual Picks.png', 6.5, 1.0, width=6.3)
...
img(s, ROOT / 'wellspot.jpg', 0.3, 1.2, width=3.5)
tb(s, 0.3, 4.3, 3.5, 0.5,
   "Photo: Scott Detrow / StateImpact PA, 2012",
   size=10, color=GRAY, align=PP_ALIGN.CENTER)
img(s, ROOT / 'pit_profile_diagram.png', 4.0, 4.0, width=8.8)
...
img(s, ROOT / 'close up errors.png', 6.3, 1.0, width=6.5)
...
img(s, ROOT / 'orphaned with no clear wells.png', 6.5, 1.2, width=6.3)
