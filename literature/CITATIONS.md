...
- **Generated:** `notebooks/wellsight_v2/s7_analysis/_smrf_reclassify_ground.py`; `docs/iterations/smrf_ground_reclassification.md`; `data/9t/results/smrf_ground/`; `docs/presentation/figures_30to45min/smrf_ground/`.
